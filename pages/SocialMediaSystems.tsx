    ...
    <div className="bg-brand-dark min-h-screen">
      <section className="relative py-40 overflow-hidden border-b border-slate-900">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 text-center space-y-8 relative z-10">
            ...
            <h1 className="text-5xl md:text-9xl font-display font-light text-white tracking-tighter">
               Visibility <span className="italic font-normal text-gradient">Systems.</span>
            </h1>
            <p className="text-xl md:text-3xl text-slate-500 max-w-3xl mx-auto leading-relaxed font-light">
               24/7 authority management and content systems designed to maintain global brand relevance.
            </p>
        </div>
      </section>
      ...
      <section className="py-40 px-6 lg:px-12 max-w-7xl mx-auto">
         <div className="grid lg:grid-cols-2 gap-12">
            {[
              { icon: Calendar, title: "Content Architecture", desc: "Strategic planning and high-volume scheduling that keeps your brand top-of-mind daily." },
              ...
              { icon: BarChart, title: "Authority Metrics", desc: "Deep analytics tracking to ensure your visibility translates into business growth." },
              { icon: Eye, title: "24/7 Presence", desc: "Managing your brand voice across multiple timezones for global market impact." }
            ].map((s, idx) => (
